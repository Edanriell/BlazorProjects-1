...
public class TaskItemsController : ControllerBase
{
    ...
    {
        if (_context.TaskItem == null) return NotFound();
    ...
    {
        if (id != taskItem.TaskItemId) return BadRequest();
    ...
    {
        if (_context.TaskItem == null) return Problem("Entity set 'TaskManagerServerContext.TaskItem'  is null.");
